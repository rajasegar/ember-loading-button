...
e.default=c.extend({layout:n.default,tagName:"button",classNames:["loading-button"],classNameBindings:["customClass"],attributeBindings:["transition:data-style","color:data-color","isLoading:data-loading","isDisabled:disabled","size:data-size"],isLoading:!1,isDisabled:s.reads("isLoading"),loaderStyle:"circular-dots-fade",click:function(){var e=this
