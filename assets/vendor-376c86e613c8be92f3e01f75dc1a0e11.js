...
e.default=c.extend({layout:n.default,tagName:"button",classNames:["loading-button"],attributeBindings:["style:data-style","color:data-color","isLoading:data-loading","isDisabled:disabled"],isLoading:!1,isDisabled:s.reads("isLoading"),loaderStyle:"loader-circular-dots-fade",click:function(){var e=this
